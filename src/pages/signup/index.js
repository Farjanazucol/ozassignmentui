...
function Signup() {
  ...
  return (
   ...
   <p className="mt-1 text-2xl font-bold  leading-8 "  style={{color:"#1E4755"}}>Sign Up</p>

   <div className="mt-8 px-24">
            <input type="text" placeholder='First Name' name="firstname" id="firstname" autoComplete="given-firstname" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6" />
          </div>
         
          <div className="mt-8 px-24 mb-12">
            <input type="text" placeholder='Last Name' name="lastname" id="lastname" autoComplete="given-lastname" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6" />
          </div>
   ...
   <div className="mt-8 px-24">
          ...
          <div className="mt-8 px-24 mb-12">
            <input type="password" placeholder='Confirm Password' name="comfirmpassword" id="confirmpassword" autoComplete="given-confirmpassword" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6" />
          </div>
