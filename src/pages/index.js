        ...
        <div className=" flex  pt-16 px-2  lg:px-32 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-between gap-x-8 gap-y-4">
          ...
          <div className="flex flex-wrap -mx-4 ">
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/4 p-4 pt-10">
              <div className='text-center max-w-[400px] min-h-[650px] border-solid border  rounded-xl border-gray-300  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 skew-y-0 grid-rows-4'>
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/4 p-4 pt-10">
              <div className='text-center  max-w-[400px] min-h-md-[450px] min-h-[650px] border-solid border rounded-xl border-gray-300 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 skew-y-0 grid-rows-4'>
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/4 p-4 pt-10">
              <div className='text-center items-center  max-w-[400px] min-h-[650px] border-solid border  rounded-xl border-gray-300 transition ease-in-out delay-150  hover:-translate-y-1 skew-y-0 hover:scale-110  duration-300 grid-rows-4'>
        ...
        <div className="flex flex-wrap  -mx-4">
          ...
          <div className="w-full sm:w-1/2 md:w-1/3  xl:1/4 p-1 pt-20 ">
            <div className=' border-2 mt-4'>
              <div className='flex px-3  mt-5 py-0 space-x-4 space-y-12'>
