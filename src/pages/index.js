...
<div className="bg-white py-4 pb-24" style={{backgroundColor:"#fbfbfb"}}> 
 ...
 <span className=' w-1/3  h-0.5 pt-0 bg-orange-600 inline-block'></span>
  ...
  <div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4 pt-10">
<div className='text-center  py-8 px-2 max-w-[370px] min-h-[600px]  border-solid border  rounded-xl border-gray-300  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 skew-y-0'>


  
  <div>
<Image  className='inline' src="/assets/online_assignment.svg" alt='onlineassesment' width={90} height={80} />
  </div>
  <div className='pt-2'>
    <h1 className='text-xl py-4 font-semibold opacity-80'>Online Assignment Help</h1>
    <p className='text-start text-gray-600 px-4'>MyAssignmenthelp.com is the leading assignment help provider worldwide. We have an exclusive
assignmenthelp
...
<div>
<Image  className='inline' src="/assets/custom_writing.svg" alt='dissertation' width={90} height={80} />
</div>
<div className='pt-2'>
  <h1 className='text-xl py-4 font-semibold opacity-80'>Custom Essay Writing Help</h1>
  <p className='text-start text-gray-600 px-6'>MyAssignmenthelp.com helps Indian students to compose different types of essays within the
givendeadline.
...
<div className='pt-2 '>
  <h1 className='text-xl py-4 font-semibold opacity-80'>

  Dissertation Writing Help
  </h1>
  <p className='text-start text-gray-600 px-4'>
  MyAssignmenthelp.com has a dedicated team of over 5,245 PhD experts to provide online
dissertation help
to overseas Indian students. Owing to their extensive knowledge and years of experience in
writing
online dissertations on various subjects and topics, our Ph.D experts easily come up with proper
referencing and citation perfectly formatted, well-structured and fully referenced dissertation
papers
to serve all your academic needs. 
  </p>
</div>
<div className=" sm:mt-6 items-center text-center">
<Link href={"/"}>
...
<div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4 pt-10">
<div className='text-center items-center max-w-[370px] min-h-[600px]  py-8 px-2  border-solid border  rounded-xl border-gray-300 transition ease-in-out delay-150  hover:-translate-y-1 skew-y-0 hover:scale-110  duration-300'> 
 

          

  <div className='items-center'>
  <Image  className='inline' src="/assets/all_writing.svg" alt='dissertation' width={90} height={80} />
  </div>
<div className='pt-2 '>
  <h1 className='text-xl py-4 font-semibold opacity-80'>
  ...
  <p className='text-start text-gray-600 px-4'>
  Our all academic writing services for the Indian students studying abroad include custom essay
writing
help, online homework assignment help, case study help, term paper help services, coursework
help,
thesis help, research paper writing help, online dissertation writing service and many more. No
matter
what subject, area or field of study a student deals with, our experts always have a custom
solution
to any your academic problem.
  </p>
</div>
<div className=" sm:mt-6 items-center text-center">
      <Link href={"/"}>
