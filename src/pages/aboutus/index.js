...
<div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/2 p-4 ">
<Image  className='inline' src="/assets/aboutimage.png" alt='about' width={800} height={80} />
    </div>
    </div>
    {/* </div> */}
</div>
...
<div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/2 p-4 ">
<Image  className='inline' src="/assets/whoimage.png" alt='about' width={800} height={80} />
    </div>
    </div>
    {/* </div> */}
</div>
